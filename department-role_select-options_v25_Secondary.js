const departmentSelect2 = document.querySelector('select[id="Secondary.department.2.profile"]');
const roleSelect2 = document.querySelector('select[id="Secondary.role.2.profile"]');
