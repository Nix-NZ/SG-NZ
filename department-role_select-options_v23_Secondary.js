const departmentSelect = document.querySelector('select[name="Account.Department.2"], select[name="Secondary.department.2.profile"]');
const roleSelect = document.querySelector('select[name="Account.Role.2"], select[name="Secondary.role.2.profile"]');
