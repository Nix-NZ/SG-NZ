const departmentSelect4 = document.querySelector('select[id="Secondary.department.2.profile"]');
const roleSelect4 = document.querySelector('select[id="Secondary.role.2.profile"]');

departmentSelect4.addEventListener('change', (event) => {
...
<option value="Catering Hand">Catering Hand</option>
        ...
        roleSelect4.innerHTML = `<option value="">Select Role</option> `;
    }
});