const departmentSelect = document.querySelector('select[name="Account.Department"], select[name="Primary.department.profile"]');
const roleSelect = document.querySelector('select[name="Account.Role"], select[name="Primary.role.profile"]');
