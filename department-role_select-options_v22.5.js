const departmentSelect = document.querySelector('select[name="Primary.department.profile"]');
const roleSelect = document.querySelector('select[name="Primary.role.profile"]');
