const departmentSelect = document.querySelector('select[name="Account.Department.2"]');
const roleSelect = document.querySelector('select[name="Account.Role.2"]');
...
departmentSelect.addEventListener('change', (event) => {
  ...
  <option value="1st AC / Focus Puller (Daily)">1st AC / Focus Puller (Daily)</option>
