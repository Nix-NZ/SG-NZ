const departmentSelect2 = document.querySelector('select[name="Secondary.department.2.profile"]');
const roleSelect2 = document.querySelector('select[name="Secondary.role.2.profile"]');
