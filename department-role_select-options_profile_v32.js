const departmentSelect3 = document.querySelector('select[name="Primary.department.profile"]');
const roleSelect3 = document.querySelector('select[name="Primary.role.profile"]');

departmentSelect3.addEventListener('change', (event) => {
    const department = event.target.value;
    if (department === 'Invalid') {
        roleSelect3.innerHTML = `
...
<option value="Extra">Extra</option>
    ...
    } else if (department === 'Rigging') {
        roleSelect.innerHTML = `
        <option value="">Select Role</option>
    <option value="HOD/Key Mountain Rigger">HOD/Key Mountain Rigger</option>
<option value="Mountain Rigger">Mountain Rigger</option>
<option value="Supervising Mountain Rigger">Supervising Mountain Rigger</option>
        ...
        roleSelect3.innerHTML = `
        <option value="">Select Role</option>
        <option value="Animation & Creature">Animation & Creature</option>
        <option value="Assistant Technical Director">Assistant Technical Director</option>
        <option value="Camera Technical Director & Matchmove artist">Camera Technical Director & Matchmove artist</option>
        <option value="Camera Tracking">Camera Tracking</option>
        <option value="CG Generalist">CG Generalist</option>
        ...
        <option value="Environment & Layout Artist">Environment & Layout Artist</option>
        <option value="FX & Simulation Artist">FX & Simulation Artist</option>
        <option value="Modeler & Sculptor">Modeler & Sculptor</option>
        <option value="MotionCapture & MotionEdit">MotionCapture & MotionEdit</option>
        <option value="On-set photography & 3D scan">On-set photography & 3D scan</option>
        <option value="Previs Artist">Previs Artist</option>
        <option value="Render Quality Control">Render Quality Control</option>
        <option value="Rotoscope & Paint Artist">Rotoscope & Paint Artist</option>
        <option value="Sequence Supervisor">Sequence Supervisor</option>
        <option value="Software Engineer">Software Engineer</option>
        <option value="Stage Operator">Stage Operator</option>
        <option value="Techvis & Postvis Artist">Techvis & Postvis Artist</option>
        <option value="Texture Artist & LookDev">Texture Artist & LookDev</option>
        <option value="VFX Asset Manager">VFX Asset Manager</option>
        <option value="VFX Assistant Data Wrangler">VFX Assistant Data Wrangler</option>
        <option value="VFX Coordinator">VFX Coordinator</option>
        <option value="VFX Data Capture Tech">VFX Data Capture Tech</option>
        <option value="VFX Data IN/OUT Tech">VFX Data IN/OUT Tech</option>
        <option value="VFX Data Wrangler">VFX Data Wrangler</option>
        <option value="VFX Photographer">VFX Photographer</option>
        <option value="VFX Pipeline">VFX Pipeline</option>
        <option value="VFX Producer">VFX Producer</option>
        <option value="VFX Production Manager">VFX Production Manager</option>
        <option value="VFX Researcher">VFX Researcher</option>
        <option value="VFX Runner">VFX Runner</option>
        <option value="VFX Supervisor">VFX Supervisor</option>
        <option value="VFX Technical Director">VFX Technical Director</option>
        <option value="VFX Trainee">VFX Trainee</option>
        <option value="VFX Witness cam operator">VFX Witness cam operator</option>
        <option value="Virtual Art Department(VAD)">Virtual Art Department(VAD)</option>
        <option value="Virtual Lighter">Virtual Lighter</option>
        <option value="Virtual Production / On-Stage">Virtual Production / On-Stage</option>
                `;
...
<option value="Catering Hand">Catering Hand</option>
        ...
        roleSelect3.innerHTML = `<option value="">Select Role</option> `;
    }
});